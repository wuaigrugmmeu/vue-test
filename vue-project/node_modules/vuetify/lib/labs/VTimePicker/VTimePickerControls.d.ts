...
export declare const makeVTimePickerControlsProps: <Defaults extends {
    ...
    period: unknown extends Defaults["period"] ? StringConstructor : {
        type: PropType<unknown extends Defaults["period"] ? string : string | Defaults["period"]>;
        default: unknown extends Defaults["period"] ? string : string | Defaults["period"];
    };
